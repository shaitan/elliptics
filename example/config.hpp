...
struct backend_config {
	...
	const cache::cache_config	cache_config;
...
struct config_data : public dnet_config_data {
	...
	// resets logger which is needed to reopen log file.
	void reset_logger();
	...
	// get actual io pool's config with re-paring config file if it was updated
