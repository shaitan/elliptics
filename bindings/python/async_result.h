...
typedef python_async_result<write_struct_result_entry>			python_write_struct_result;
typedef python_async_result<read_struct_result_entry>			python_read_struct_result;
